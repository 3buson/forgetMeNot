...
const TRACK_URL_BASE = 'https://track.celtra.io/json/'
...
export async function track (data) {
    ...
    data = {
        eventType: 'forgetMeNotExtension',
        ...data,
    }
    const base64Data = btoa(JSON.stringify(data))
    const trackUrl = `${TRACK_URL_BASE}${base64Data}?crc32c=${crc32(base64Data)}`
